...
##
## cparm: the Tsallis parameters and their corresponding fishr errors of the
## returns for all delays. n x m matrix, n = no. of delays, m = delay value + no. of parameters and errors 
## cparm (columns) = [delay theta kapa mu q beta erqm erbm ermum erqe erbe ermue]
##                                 
...
function [ cmom cparm ] = qstock_mainold(file_name,  col=8, mm1, dd1, yr1, mm2, dd2, yr2, d_days=1, n_days=10,  ql=1.2, qh=1.66, btl=.5, bth=1.5, mul = -.0005, niter=8,  opt_kptheta=0)
