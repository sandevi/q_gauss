...
function [cmom cparm]  = qgauss_prmestold(x, col=8,r1,r2,d_wks=1, n_wks=10,  ql=1.2, qh=1.66, btl=.5, bth=1.5, mul = -.0005, niter=8,  opt_kptheta=0)
...
## Compute fisher measured and expected error
    ...
    [erqm erbm  ermum erqe erbe ermue] = est_mlerrqbmu(lrx, mut, thetat, kapt, mom1(2))  ;
	 ...
	 cparm{iw+1,1} = [thetat kapt mut qt betat  erqm erbm ermum erqe erbe ermue]  ;
